...
def detect_standard_layer(dataset_path, layer_name, exact_bounding_box=None, category="color"):
...
def detect_segmentation_layer(
    ...
    layer_info = detect_standard_layer(dataset_path, layer_name, exact_bounding_box, category="segmentation")
    layer_info["mappings"] = []
