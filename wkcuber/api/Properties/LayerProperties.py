...
def extract_num_channels(num_channels_in_properties, path, layer, mag):
    ...
    if mag is None:
        ...
        raise RuntimeError("Cannot extract the number of channels of a dataset without a properties file and without any magnifications")
    ...
    def _from_json(cls, json_data, resolution_type, dataset_path):
        ...
        layer_properties = cls(
            ...
            extract_num_channels(
                ...
                dataset_path,
                json_data["name"],
                json_data["wkwResolutions"][0] if len(json_data["wkwResolutions"]) > 0 else None,
            ),
