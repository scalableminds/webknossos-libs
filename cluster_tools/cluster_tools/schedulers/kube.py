    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            logger.error(
                "The Kubernetes Python package is not installed. cluster_tools does not install this dependency be default. Run pip install cluster_tools[kubernetes] to install Kubernetes support."
            )
            exit()
