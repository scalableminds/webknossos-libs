...
class Layer:
    ...
    def _get_dataset_from_align_with_other_layers(
        self, align_with_other_layers: bool | "Dataset"
    ) -> "Dataset" | None:
    ...
    def downsample(
        ...
        *,
        ...
        align_with_other_layers: bool | "Dataset" = True,
    ...
    def _setup_mag(self, mag: Mag, path: str | PathLike | None = None) -> None:
    ...
    @classmethod
    def _ensure_layer(cls, layer: str | PathLike | "Layer") -> "Layer":
