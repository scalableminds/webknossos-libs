...
T = TypeVar("T", bound="InfoResponse200DataStore")


@attr.s(auto_attribs=True)
class InfoResponse200DataStore:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        info_response_200_data_store = cls(
            name=name,
            url=url,
        ...
        info_response_200_data_store.additional_properties = d
        return info_response_200_data_store
