...
T = TypeVar("T", bound="AnnotationInfoResponse200OwnerTeamsItem")
...
class AnnotationInfoResponse200OwnerTeamsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        annotation_info_response_200_owner_teams_item = cls(
            id=id,
            name=name,
            is_team_manager=is_team_manager,
        )

        annotation_info_response_200_owner_teams_item.additional_properties = d
        return annotation_info_response_200_owner_teams_item
