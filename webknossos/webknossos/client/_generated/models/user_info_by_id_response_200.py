...
from ..models.user_info_by_id_response_200_experiences import (
    UserInfoByIdResponse200Experiences,
)
from ..models.user_info_by_id_response_200_novel_user_experience_infos import (
    UserInfoByIdResponse200NovelUserExperienceInfos,
)
from ..models.user_info_by_id_response_200_teams_item import (
    UserInfoByIdResponse200TeamsItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UserInfoByIdResponse200")
...
class UserInfoByIdResponse200:
    ...
    experiences: Union[Unset, UserInfoByIdResponse200Experiences] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        experiences: Union[Unset, UserInfoByIdResponse200Experiences]
        if isinstance(_experiences, Unset):
            experiences = UNSET
        else:
            experiences = UserInfoByIdResponse200Experiences.from_dict(_experiences)
        ...
        if isinstance(_novel_user_experience_infos, Unset):
            ...
            novel_user_experience_infos = (
                UserInfoByIdResponse200NovelUserExperienceInfos.from_dict(
        ...
        return user_info_by_id_response_200
