...
class AnnotationInfosByTaskIdResponse200ItemTaskTypeSettings:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resolution_restrictions = AnnotationInfosByTaskIdResponse200ItemTaskTypeSettingsResolutionRestrictions.from_dict(
        ...
        return annotation_infos_by_task_id_response_200_item_task_type_settings
