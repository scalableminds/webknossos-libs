...
class TaskInfoResponse200TypeSettings:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resolution_restrictions = (
            TaskInfoResponse200TypeSettingsResolutionRestrictions.from_dict(
                d.pop("resolutionRestrictions")
            )
        )

        task_info_response_200_type_settings = cls(
        ...
        task_info_response_200_type_settings.additional_properties = d
        return task_info_response_200_type_settings
