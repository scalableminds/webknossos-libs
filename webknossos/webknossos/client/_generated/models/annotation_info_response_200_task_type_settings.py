...
class AnnotationInfoResponse200TaskTypeSettings:
    ...
    merger_mode: int
    resolution_restrictions: AnnotationInfoResponse200TaskTypeSettingsResolutionRestrictions
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resolution_restrictions = (
            AnnotationInfoResponse200TaskTypeSettingsResolutionRestrictions.from_dict(
                d.pop("resolutionRestrictions")
            )
        )

        annotation_info_response_200_task_type_settings = cls(
        ...
        annotation_info_response_200_task_type_settings.additional_properties = d
        return annotation_info_response_200_task_type_settings
