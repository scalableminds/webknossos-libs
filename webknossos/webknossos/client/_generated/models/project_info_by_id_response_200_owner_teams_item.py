...
T = TypeVar("T", bound="ProjectInfoByIdResponse200OwnerTeamsItem")
...
class ProjectInfoByIdResponse200OwnerTeamsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_info_by_id_response_200_owner_teams_item = cls(
            id=id,
            name=name,
            is_team_manager=is_team_manager,
        )

        project_info_by_id_response_200_owner_teams_item.additional_properties = d
        return project_info_by_id_response_200_owner_teams_item
