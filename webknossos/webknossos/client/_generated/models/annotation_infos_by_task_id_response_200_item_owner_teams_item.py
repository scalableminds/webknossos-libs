...
T = TypeVar("T", bound="AnnotationInfosByTaskIdResponse200ItemOwnerTeamsItem")
...
class AnnotationInfosByTaskIdResponse200ItemOwnerTeamsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        annotation_infos_by_task_id_response_200_item_owner_teams_item = cls(
            id=id,
            name=name,
            is_team_manager=is_team_manager,
        )

        annotation_infos_by_task_id_response_200_item_owner_teams_item.additional_properties = (
            d
        )
        return annotation_infos_by_task_id_response_200_item_owner_teams_item
