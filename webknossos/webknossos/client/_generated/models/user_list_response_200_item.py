...
class UserListResponse200Item:
    ...
    experiences: Union[Unset, UserListResponse200ItemExperiences] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        experiences: Union[Unset, UserListResponse200ItemExperiences]
        if isinstance(_experiences, Unset):
            experiences = UNSET
        else:
            experiences = UserListResponse200ItemExperiences.from_dict(_experiences)
