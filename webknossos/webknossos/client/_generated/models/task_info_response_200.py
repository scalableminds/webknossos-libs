...
from ..models.task_info_response_200_bounding_box import TaskInfoResponse200BoundingBox
...
class TaskInfoResponse200:
    ...
    tracing_time: str
    creation_info: str
    bounding_box: TaskInfoResponse200BoundingBox
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        bounding_box = TaskInfoResponse200BoundingBox.from_dict(d.pop("boundingBox"))
