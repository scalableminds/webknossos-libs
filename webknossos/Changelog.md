...
- `Dataset.trigger_dataset_upload()` was added to trigger an imidiate refresh of the dataset list on webknossos. [#1236](https://github.com/scalableminds/webknossos-libs/pull/1236)
