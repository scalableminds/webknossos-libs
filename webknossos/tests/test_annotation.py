...
def test_annotation_from_wkw_zip_file() -> None:
    ...
    assert (
        "timestamp" in annotation.metadata  # pylint: disable=unsupported-membership-test
    )
    ...
    assert (
        "timestamp" in copied_annotation.metadata  # pylint: disable=unsupported-membership-test
    )
